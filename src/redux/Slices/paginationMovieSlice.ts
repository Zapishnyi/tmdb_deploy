...
export const paginationMovieSlice = createSlice({
  name: 'pagination_movie',
  initialState,
  reducers: {
    setPaginationDownloaded: (
      state,
      { payload: { page, total_pages, total_results } }: PayloadAction<IMoviesPaginated>,
    ) => {
...
export const PaginationMovieAction = paginationMovieSlice.actions;
